...
class SummerJob implements ActionListener
  {  
   JLabel displayLabel;
   JButton nextButton;
   JButton prevButton;
   ...
   ResourceBundle summerResources;
   ...
   SummerJob()
     {  
      try
        {
         summerResources = ResourceBundle.getBundle("resources.SummerJobResources",Locale.getDefault());
        }
      ...
      JFrame jfrm = new JFrame(summerResources.getString("Title"));  
      ...
      prevButton = new JButton(summerResources.getString("Prev"));
      prevButton.setActionCommand("Prev");
      buttonPanel.add(prevButton);
      prevButton.addActionListener(this);
      
      nextButton = new JButton(summerResources.getString("Next"));
   ...
   private void nextUIState() throws Exception
     {
      ...
      if (fv.getFactSlot("state").toString().equals("final"))
        { 
         ...
         nextButton.setText(summerResources.getString("Restart")); 
         prevButton.setVisible(true);
        }
      else if (fv.getFactSlot("state").toString().equals("initial"))
        {
         nextButton.setActionCommand("Next");
         nextButton.setText(summerResources.getString("Next"));
      ...
      for (int i = 0; i < pv.size(); i++) 
        {
         ...
         if (bv.toString().equals(selected))
            { rButton = new JRadioButton(summerResources.getString(bv.toString()),true); }
         else
            { rButton = new JRadioButton(summerResources.getString(bv.toString()),false); }
      ...
      String theText = summerResources.getString(fv.getFactSlot("display").symbolValue());
